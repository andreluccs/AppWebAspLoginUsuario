...
namespace AppWebAspLoginUsuario
{
    public partial class Dashboard : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            con.ConnectionString = "Data Source=36DE250010\\SENAC;Initial Catalog=atividae;Integrated Security=True";
            /* Abertura da Conexão */
            con.Open();
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            dt = new DataTable();
            /* Comando SQL */
            cmd.CommandText = "UPDATE usuario  SET email='" + txbEmail.Text.ToString() + "', pass='" + txbPass.Text.ToString() + "' WHERE id_usuario='"+id_usuario+"'";
            /* Abre a Conexão */
            cmd.Connection = con;
            /* Executa a Query SQL */
            cmd.ExecuteNonQuery();
